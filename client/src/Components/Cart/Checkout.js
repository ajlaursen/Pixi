        ...
        <div class="flex flex-col justify-center items-center">
            ...
            <div class="md:w-1/3 sm:w-full rounded-lg shadow-lg bg-white my-3">
                ...
                <div class="px-10 py-5 text-gray-600">
                   Soon enough you'll be able to purchased your favorite artists digital prints. Stick with us!
            	</div>

              
            </div>

            <div className="container mx-auto px-40 box-border box-shadow bg-pixi rounded-lg font-serif text-2xl mt-12 ">
